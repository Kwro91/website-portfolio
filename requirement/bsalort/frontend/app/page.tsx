    ...
    <main className="allpage">
      ...
      <div>
        <section className="homeSection">
          ...
          <p className="homeP">Concernant le web, je suis fullstack, en front du TailwindCss, NextJs (react), Javascript et Typescript.</p>
          <p className="homeP">Et pour finir en back du Fastify ou du NestJs.</p>
        </section>
      </div>
      <div>
        <section className="homeSection">
